...
ls -la ./
ls -la $PWD/docs
ls -la $PWD/docs/changelog
ls -la $PWD/docs/changelog/client-side

echo "$file" > ./bucketeer-docs/${DOC_FILEPATH}/${DOC_FILENAME}
cat ./bucketeer-docs/${DOC_FILEPATH}/${DOC_FILENAME}

# Delete the temp file
rm $CHANGELOG_TEMP_FILE

echo "File ./${DOC_FILENAME} created."
